...
# Maintainer-only: bundle the companion's TypeScript into the committed ES
# module src/companion/companion.js (src/companion/build.sh). Needs npm.
build-companion:
	@sh src/companion/build.sh
