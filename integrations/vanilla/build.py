...
def main() -> None:
    ...
    # The inspector: its script, and what it loads from beside itself when
    # opened – the panel (panel/, vendor/), its stylesheet and the page agent.
    shutil.copytree(SRC / 'inspector', out / 'inspector', dirs_exist_ok=True,
