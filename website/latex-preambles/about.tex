...
% which is set ragged right, as the section headings are.
...
\NewDocumentCommand\pagetitle{o m}{%
  ...
  {\raggedright\LARGE\bfseries #2\par}\@afterindentfalse\@afterheading}
\makeatother
% About and Showcase: hyperref for their links (the repository, the papers).
\usepackage{hyperref}
